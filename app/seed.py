...
COACHES_SEED: list[CoachSeed] = [
    CoachSeed(
        ...
        calendly_url="https://calendly.com/acakic92/30min",
        sort_order=0,
    ),
    CoachSeed(
...
SUCCESS_STORIES_SEED: list[SuccessStorySeed] = [
    SuccessStorySeed(
        slug="sr-engineer-to-staff",
        client_name="Jordan",
        client_role_before="Senior Software Engineer",
        client_role_after="Staff Software Engineer",
        client_company_after="Top-tier cloud platform",
        story_short=(
            "Stuck at senior for three years, Jordan went from 'putting in the time' to a "
            "clear staff promotion path in nine months."
        ),
        coach_slug="alex",
        is_featured=True,
        sort_order=0,
    ...
    SuccessStorySeed(
        slug="pm-pivot-to-fintech",
        client_name="Sara",
        client_role_before="Product Manager, B2B SaaS",
        client_role_after="Senior Product Manager",
        client_company_after="Public fintech",
        story_short=(
            "Pivoted from horizontal B2B SaaS into fintech with a senior title and a 40% comp "
            "bump, despite having zero fintech background."
        ),
        coach_slug="atiyeh",
        is_featured=True,
        sort_order=1,
    ...
    SuccessStorySeed(
        slug="layoff-to-better-role",
        client_name="Mei",
        client_role_before="Engineering Manager (laid off)",
        client_role_after="Director of Engineering",
        client_company_after="Growth-stage startup",
        story_short=(
            "Six weeks from layoff to signed Director offer — better title, better team, and "
            "clarity she actually wanted leadership."
        ),
        coach_slug="alex",
        is_featured=False,
        sort_order=2,
